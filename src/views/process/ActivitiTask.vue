        ...
        <el-row class="taskCard">
            ...
            <div class = "demo">
                <el-row>
                    ...
                    <page-render :pageData="this.pageData" :setHistoryTask="this.setActivitiTask"></page-render>
                </el-row>
            </div>
        </el-row>
    </div>
...
// import { getActivitiTask } from "@/http/api";
...
export default {
  data () {
    return {
      tableData: [],
      pageData: [],
      tableType: 'ActivitiTask',
      input: ''
    }
  },
  created () {
    this.setActivitiTask(1, 10)
  },
  methods: {
  /* setActivitiTask(pageNo,pageSize){
        getActivitiTask({
            pageNo: pageNo,
            pageSize: pageSize,
        }).then( res => {
