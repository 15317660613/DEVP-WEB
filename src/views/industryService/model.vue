<template>
  <div class="content">
    <div class="table-wrapper">
      <div style="float: left"><span style="font-weight: bold;font-size: 14px;margin-right: 10px">车型申报管理</span> <span
      ...
      <div class="tool-btn-group">
        ...
        <div style="float: right;margin-left: 10px">
          <el-input placeholder="请输入车辆型号" v-model="model" class="input-with-select" size="mini">
        ...
        methods: {
            ...
            handleEdit(index, row) {
                ...
                getModelDetail(row.id).then((res) => {
                    ...
                    this.temp.brand = res.data.brand;
                    this.temp.business = res.data.business;
                    for (let i = 0; i < res.data.properties.length; i++) {
                        if (res.data.properties[i].id === '2') {
                            for (let j = 0; j < res.data.properties[i].children.length; j++) {
