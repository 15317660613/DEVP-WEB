  ...
  <div class="content">
    ...
    <div class="table-wrapper">
      ...
      <div class="tool-btn-group">
        ...
        <el-button size="mini" @click="startBatch">批量提交</el-button>
        <el-checkbox v-model="checked" style="margin: 0 10px" @change="filterStatus">未审核</el-checkbox>
          <el-input
      ...
      >
        ...
        <el-table-column label="城市" align="center" show-overflow-tooltip :formatter="formatterCity">
        ...
        <el-table-column label="企业社会信用代码" align="center" width="150" show-overflow-tooltip>
...
<script>
  ...
  import { getProgressImageData, completeTaskBatch, startProcessBatch } from '@/assets/api/process'
    ...
    methods: {
      ...
      agreeBatch() {
        ...
        for (let i = 0; i < this.multipleSelection.length; i++) {
          ids.push(this.multipleSelection[i].workFlowId);
        }
      ...
      startBatch () {
        ...
        startProcessBatch(ids).then(({res}) => {
          if (data.code === '200') {
      ...
      changeAgree(row) {
        this.$confirm('是否确认提交审批意见', '提示', {
          ...
          params.taskIdArray = [row.workFlowId];
          params.formContent = "";
          params.isAgencyTask = 0;
          params.type = 0;
          completeTaskBatch(params).then((res) => {
